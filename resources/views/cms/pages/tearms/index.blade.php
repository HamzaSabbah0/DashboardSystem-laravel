        ...
        <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    <form action="{{ route('panel.tearms.post') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control" id="descriptionAr" name="description_ar" rows="3" placeholder="الوصف باللغة العربة"
                                    required>{{ old('description_ar', $tearms ? $tearms->description_ar : '') }}</textarea>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control" id="descriptionEn" name="description_en" rows="3"
                                    placeholder="الوصف باللغة الانجليزية " required>{{ old('description_en', $tearms ? $tearms->description_en : '') }}</textarea>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control" id="descriptionTu" name="description_tu" rows="3"
                                    placeholder="الوصف باللغة التركية" required>{{ old('description_tu', $tearms ? $tearms->description_tu : '') }}</textarea>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control" id="descriptionFr" name="description_fr" rows="3"
                                    placeholder="الوصف باللغة الفرنسية" required>{{ old('description_fr', $tearms ? $tearms->description_fr : '') }}</textarea>
