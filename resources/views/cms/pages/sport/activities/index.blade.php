                            ...
                            <tbody>
                                @foreach ($activities as $activity)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>
                                            <img class="img-circle img-bordered-sm" src="{{ $activity->photo }}"
                                                width="80" alt="Image">
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                ...
                                                <a href="{{ route('panel.sport.activities.show', $activity->id) }}"
                                                    class="btn btn-outline-primary">
                                                    <i class="fa-regular fa-eye"></i>
                                                </a>
                                                <form action="{{ route('panel.sport.activities.destroy', $activity->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
