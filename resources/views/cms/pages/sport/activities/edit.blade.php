    ...
    <div class="col-lg-12 col-12 layout-spacing layout-top-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                <form action="{{route('panel.sport.activities.update', $elevenActivity->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="form-row mb-4 col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title_ar" id="titleAr"
                                    placeholder="اسم باللغة العربية" value="{{ old('title_ar', $elevenActivity ? $elevenActivity->title_ar : '') }}" required>
                                @error('title_ar')
                        ...
                        <div class="form-row mb-4 col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title_en" id="titleEn"
                                    placeholder="اسم نشاط باللغة الانجليزية" value="{{ old('title_en', $elevenActivity ? $elevenActivity->title_en : '') }}" required>
                                @error('title_en')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-row mb-4 col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title_tu" id="titleTu"
                                    placeholder="اسم النشاط باللغة التركية" value="{{ old('title_tu', $elevenActivity ? $elevenActivity->title_tu : '') }}" required>
                                @error('title_tu')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-row mb-4 col">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title_fr" id="titleFr"
                                    placeholder="اسم النشاط باللغة الفرنسية" value="{{ old('title_fr', $elevenActivity ? $elevenActivity->title_fr : '') }}" required>
                                @error('title_fr')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea class="form-control" id="descriptionAr" name="description_ar" rows="3" placeholder="الوصف باللغة العربة"
                            required>{{ old('description_ar',$elevenActivity ? $elevenActivity->description_ar : '') }}</textarea>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea class="form-control" id="descriptionEn" name="description_en" rows="3"
                            placeholder="الوصف باللغة الانجليزية " required>{{ old('description_en',$elevenActivity ? $elevenActivity->description_en : '') }}</textarea>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea class="form-control" id="descriptionTu" name="description_tu" rows="3"
                            placeholder="الوصف باللغة التركية" required>{{ old('description_tu',$elevenActivity ? $elevenActivity->description_tu : '') }}</textarea>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea class="form-control" id="descriptionFr" name="description_fr" rows="3"
                            placeholder="الوصف باللغة الفرنسية" required>{{ old('description_fr',$elevenActivity ? $elevenActivity->description_fr : '') }}</textarea>
    ...
    <script>
        $(document).ready(function() {
            ...
            new FileUploadWithPreview('myFirstImage', {
                presetFiles: ["{{ $elevenActivity->photo }}"]
            });
        });
    </script>
@endpush
