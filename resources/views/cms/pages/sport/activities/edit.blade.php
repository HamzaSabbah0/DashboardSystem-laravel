        ...
        <div class="col-lg-12 col-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    <form action="{{ route('panel.sport.activities.update', $elevenActivity->id) }}" method="POST"
                            ...
                            <div class="form-row mb-4 col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title_ar" id="titleAr"
                                        placeholder="اسم باللغة العربية"
                                        value="{{ old('title_ar', $elevenActivity ? $elevenActivity->title_ar : '') }}"
                                        required>
                                    @error('title_ar')
                            ...
                            <div class="form-row mb-4 col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title_en" id="titleEn"
                                        placeholder="اسم نشاط باللغة الانجليزية"
                                        value="{{ old('title_en', $elevenActivity ? $elevenActivity->title_en : '') }}"
                                        required>
                                    @error('title_en')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-row mb-4 col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title_tu" id="titleTu"
                                        placeholder="اسم النشاط باللغة التركية"
                                        value="{{ old('title_tu', $elevenActivity ? $elevenActivity->title_tu : '') }}"
                                        required>
                                    @error('title_tu')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-row mb-4 col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title_fr" id="titleFr"
                                        placeholder="اسم النشاط باللغة الفرنسية"
                                        value="{{ old('title_fr', $elevenActivity ? $elevenActivity->title_fr : '') }}"
                                        required>
                                    @error('title_fr')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
