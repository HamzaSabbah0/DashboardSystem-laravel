...
class ProgrammingSlidersController extends Controller
{
    use FileManager;
    /**
    ...
    {
        $sliders = Slider::where('section_title','programming_page')->paginate(10);
        return view('cms.pages.programming.sliders.index' , compact('sliders'));
    }
    ...
    {
        return view('cms.pages.programming.sliders.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('photo')) {
            $slider->photo = $this->upload_file($request->photo, 'programming-sliders');
        }
        ...
        $slider->section_title = 'programming_page';
    ...
    {
        return view('cms.pages.programming.sliders.edit' , compact('slider'));
    }
