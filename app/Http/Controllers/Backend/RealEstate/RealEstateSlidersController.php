...
class RealEstateSlidersController extends Controller
{
    use FileManager;
    /**
    ...
    {
        $sliders = Slider::where('section_title','real_estate')->paginate(10);
        return view('cms.pages.real_estate.sliders.index' , compact('sliders'));
    }
    ...
    {
        return view('cms.pages.real_estate.sliders.create');
    }
    ...
    {
        return view('cms.pages.real_estate.sliders.edit', compact('slider'));
    }
