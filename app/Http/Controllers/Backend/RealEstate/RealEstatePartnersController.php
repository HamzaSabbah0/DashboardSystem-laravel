...
class RealEstatePartnersController extends Controller
{
    use FileManager;
    /**
    ...
    {
        $partners = ElevenPartner::where('section_title','real_estate')->paginate(10);
        return view('cms.pages.real_estate.partners.index' , compact('partners'));
    }
    ...
    {
        return view('cms.pages.real_estate.partners.create');
    }
